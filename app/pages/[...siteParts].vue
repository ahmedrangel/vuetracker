    ...
    <div v-if="result" class="flex flex-col gap-6 2xl:w-1/2 xl:w-3/5 lg:w-3/4 mx-auto py-2 sm:py-3 md:py-4">
      <div class="tracking-tight flex flex-col gap-1">
        <div class="flex gap-2 items-center justify-center">
          <img :src="findFavicon(result.icons) || `https://${result.hostname}/favicon.ico`" class="min-w-6 max-w-6 min-h-6 max-h-6" loading="lazy" @error="hideImageOnError">
      ...
      <img v-if="result.ogImage" :src="result.ogImage" class="rounded-xl" loading="lazy" @error="hideImageOnError">

...
<template>
  <main>
    <div v-if="result" class="flex flex-col gap-6 2xl:w-1/2 xl:w-3/5 lg:w-3/4 mx-auto py-2 sm:py-3 md:py-4">
      ...
      <img v-if="result.ogImage && !result.ogImageLoadError" :src="result.ogImage" class="rounded-xl" loading="lazy" @error="result.ogImageLoadError = true" @load="result.ogImageLoadError = false">

...
<template>
  <div class="flex flex-col w-full bg-gray-200 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 rounded-xl overflow-hidden">
    ...
    <div class="flex justify-center items-center px-2 py-3 gap-1">
      <img v-if="img" class="w-7 h-7" :src="img">
